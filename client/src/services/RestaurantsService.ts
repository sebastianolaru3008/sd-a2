...
import { axiosGetRequest, axiosPostRequest, axiosPutRequest } from "./api/axios";

export const getRestaurantsRequest = () => axiosGetRequest<Restaurant[]>("/restaurant","");

export const addRestaurantRequest = (data:RestaurantDto) => axiosPostRequest<RestaurantDto, Restaurant>("/restaurant","", data );

export const addFoodRequest = (data:FoodDto) => axiosPostRequest<FoodDto, Food>("/food","", data );
