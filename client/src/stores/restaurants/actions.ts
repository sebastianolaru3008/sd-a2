...
import { changeOrderStatusRequest, getRestaurantsRequest } from "../../services/RestaurantsService";
...
export const changeOrderStatus = (orderId: string, orderStatus: string) : ThunkAction < void, RootState, null, AnyAction> => 

async (dispatch) =>{
    try{
      console.log("🚀 ~ file: actions.ts ~ line 19 ~ orderId", orderId);
        console.log("🚀 ~ file: actions.ts ~ line 19 ~ orderStatus", orderStatus);
